...
class ListTodayCommand extends BaseListCommand
{
    protected $name = 'listToday';

    protected $aliases = ['listtoday'];
    ...
    public function handle()
    {
        ...
        $spends = \App\Models\Money::whereDate('created_at', date('Y-m-d'))
    ...
    private function getTitle()
    {
        $text = \Lang::get(
            ...
            [
                'date' => \Lang::get(
                    'money.list.success.current_day',
                    [
                        'date' => date('d.m'),
                    ]
                ),
